                ...
                <div class="form-body">
                    <div class="modal-body">
                        <div class="row m-0 p-2">
                            ...
                            <div class="col-lg-4 p-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="btag">
                                        <option selected disabled> Select Blog Tag </option>
                                        ...
                                        <option value="<?php echo e($val->id); ?>"><?php echo e($val->tag); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 p-2">
                                <img style="width:150px; height: 150px; object-fit: contain;" src="" id="blog_image">
                            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pharma\resources\views/admin/blog/blogsadd.blade.php ENDPATH**/ ?>
