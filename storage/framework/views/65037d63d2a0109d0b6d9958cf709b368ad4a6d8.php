                    ...
                    <div class="modal-body">
                        <div class="row m-0 p-2">
                            ...
                            <div class="col-lg-4 p-2">
                                <div class="form-group">
                                    <label for="name">Category</label>
                                    <select class="form-control" name="btag">
                                        ...
                                        <option value="<?php echo e($val->id); ?>" <?php if($res->tag_id == $val->id): ?> selected <?php endif; ?>><?php echo e($val->tag); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-4 p-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo e($res->title); ?>" id="" name="btitle">
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pharma\resources\views/admin/blog/blog_edit.blade.php ENDPATH**/ ?>
