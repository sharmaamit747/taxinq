            ...
            <div class="col-md-6 col-sm-5 co-xs-12 text-right">
                <div class="bread">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><?php echo e($cat->title); ?></li>
                    </ol>
                </div>
                <!-- end bread -->
            </div>
...
<?php echo $__env->make('layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yantramonline/public_html/taxinq.com/resources/views/web/blog_category.blade.php ENDPATH**/ ?>
