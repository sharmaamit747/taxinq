    ...
    <div class="page-content">
        <div class="row pt-2 pb-2">
            ...
            <div class="col-lg-3 text-right">
                <a href="<?php echo e(url('admin/appointments')); ?>" class="btn btn-outline-primary"><i class="fa fa-angle-double-left" aria-hidden="true"></i> Back</a>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <p class="mb-0 ms-sm-12 text-muted col-lg-12  text-right">
                            <a id="allote-con" pid="<?php echo e($rid); ?>" data-bs-toggle="modal" data-bs-target="#allote-consultant" href="#" class="btn btn-primary ms-auto radius-10">
                                Allot Consultant
                            </a>
                        </p>
                        <div class="col-12 col-lg-6">
                            <table class="table table-sm table-borderless mt-md-0 mt-3">
                                <tbody>
                                    <tr>
                                        <th>Name:</th>
                                        <td><?php echo e($res->your_name); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Email:</th>
                        ...
                        <div class="col-12 col-lg-6">
                            <table class="table table-sm table-borderless mt-md-0 mt-3">
                                <tbody>
                                    <tr>
                                        <th>Query Type:</th>
                                        <td><?php echo e($res->qtitle); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Law:</th>
                                        <td><?php echo e($res->ltitle); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Consultant:</th>
                                        ...
                                        <?php else: ?>
                                        <td id="allote-consultss"><?php echo e($res->cname); ?></td>
                                        <?php endif; ?>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <div class="card shadow-none border mb-0 radius-15">
                                <div class="card-body">
                                    <div class="row m-0">
                                        ...
                                        <p class="mb-0 ms-sm-3 text-muted col-lg-3  text-right">
                                            <a id="chat-btn" pid="<?php echo e($rid); ?>" data-bs-toggle="modal" data-bs-target="#email-chat" href="#" class="btn btn-secondary compose-mail-btn">
...
<div class="modal fade" id="allote-consultant" tabindex="-1" role="dialog" aria-labelledby="allote-consultant" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content border-primary">
            ...
            <form id="allote_consultant" class="smooth-submit" method="post" action="<?php echo e(url('admin/allote_consultant')); ?>">
                <div class="form-body">
                        ...
                        <div class="row m-0 p-2">
                            <div class="col-lg-12 p-2">
                                <div class="form-group">
                                    ...
                                    <input id="appointmentId" required="true" type="hidden" value="<?php echo e($rid); ?>" class="form-control" name="id">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\taxinq\resources\views/admin/appointment/edit_appointment.blade.php ENDPATH**/ ?>
