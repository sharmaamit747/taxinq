...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title>Arif Pharma</title>
        <link rel="icon" href="<?php echo e(url('assetsweb/images/others/favicon.ico')); ?>">
        <link rel="stylesheet" href="<?php echo e(url('assetsweb/vendors/lightgallery/css/lightgallery-bundle.min.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(url('assetsweb/vendors/fontawesome/css/all.min.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(url('assetsweb/vendors/animate/animate.min.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(url('assetsweb/vendors/slick/slick.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(url('assetsweb/vendors/mapbox-gl/mapbox-gl.min.css')); ?>">
        ...
        <link rel="stylesheet" href="<?php echo e(url('assetsweb/css/theme.css')); ?>">
    </head>
    <body>
                ...
                <div class="main-header nav navbar bg-body navbar-light navbar-expand-xl py-6 py-xl-0">
                    <div class="container-wide container flex-nowrap">
                        ...
                        <div class="d-none d-xl-flex w-xl-50">
                            <ul class="navbar-nav">
                                <li class="nav-item transition-all-xl-1 py-11 me-xxl-12 me-xl-10 dropdown dropdown-hover dropdown-fullwidth">
                                    <a class="nav-link d-flex justify-content-between position-relative py-0 px-0 text-uppercase fw-semibold ls-1 fs-14px dropdown-toggle" href="index.html" data-bs-toggle="dropdown" id="menu-item-home" aria-haspopup="true" aria-expanded="false">Home</a><div class="dropdown-menu mega-menu start-0 py-6 " aria-labelledby="menu-item-home" style="width:320px">
                                ...
                                <li class="nav-item transition-all-xl-1 py-11 me-xxl-12 me-xl-10 dropdown dropdown-hover dropdown-fullwidth position-static">
                                    <a class="nav-link d-flex justify-content-between position-relative py-0 px-0 text-uppercase fw-semibold ls-1 fs-14px dropdown-toggle" href="store.html" data-bs-toggle="dropdown" id="menu-item-shop" aria-haspopup="true" aria-expanded="false">Shop</a><div class="dropdown-menu mega-menu start-0 py-6  w-100" aria-labelledby="menu-item-shop">
                                        <div class="megamenu-shop container-wide py-8 px-12">
                                            <div class="row">
                                                <div class="col">
                                                    <h6 class="fs-18px">Shop</h6>
                                                    <ul class="list-unstyled mb-0">
                                                        
                                                    </ul>
                                                </div>
                                                <div class="col">
                                                    <h6 class="fs-18px">Product</h6>
                                                    <ul class="list-unstyled mb-0">
                                ...
                                <li class="nav-item transition-all-xl-1 py-11 me-xxl-12 me-xl-10 dropdown dropdown-hover">
                                    <a class="nav-link d-flex justify-content-between position-relative py-0 px-0 text-uppercase fw-semibold ls-1 fs-14px dropdown-toggle" href="#" data-bs-toggle="dropdown" id="menu-item-pages" aria-haspopup="true" aria-expanded="false">Pages</a><ul class="dropdown-menu py-6" aria-labelledby="menu-item-pages"><li class="dropend dropdown-hover" aria-haspopup="true" aria-expanded="false">
                        ...
                        <a href="index-2.html" class="navbar-brand px-8 py-4 mx-auto">
                            <img class="light-mode-img" src="<?php echo e(asset('assetsweb/images/others/logo.png')); ?>" width="80" height="80" alt="Glowing - Bootstrap 5 HTML Templates">
                            <img class="dark-mode-img" src="<?php echo e(asset('assetsweb/images/others/logo-white.png')); ?>" width="80" height="80" alt="Glowing - Bootstrap 5 HTML Templates"></a>
            ...
            <div class="container container-xxl pt-4">
                ...
                <div class="row align-items-center mt-0 mt-lg-20 pt-lg-4">
                    <div class="col-sm-12 col-md-6 col-lg-4 d-flex align-items-center order-2 order-lg-1 fs-6 mt-8 mt-lg-0">
                        <p class="mb-0">© Arif Medico Academy 2023</p>
        ...
        <script src="<?php echo e(asset('assetsweb/vendors/bootstrap/js/bootstrap.bundle.js')); ?>"></script>
        <script src="<?php echo e(asset('assetsweb/vendors/clipboard/clipboard.min.js')); ?>"></script>
        <script src="<?php echo e(asset('assetsweb/vendors/vanilla-lazyload/lazyload.min.js')); ?>"></script>
        <script src="<?php echo e(asset('assetsweb/vendors/waypoints/jquery.waypoints.min.js')); ?>"></script>
        <script src="<?php echo e(asset('assetsweb/vendors/lightgallery/lightgallery.min.js')); ?>"></script>
        <script src="<?php echo e(asset('assetsweb/vendors/lightgallery/plugins/zoom/lg-zoom.min.js')); ?>"></script>
        <script src="<?php echo e(asset('assetsweb/vendors/lightgallery/plugins/thumbnail/lg-thumbnail.min.js')); ?>"></script>
        <script src="<?php echo e(asset('assetsweb/vendors/lightgallery/plugins/video/lg-video.min.js')); ?>"></script>
        <script src="<?php echo e(asset('assetsweb/vendors/lightgallery/plugins/vimeoThumbnail/lg-vimeo-thumbnail.min.js')); ?>"></script>
        <script src="<?php echo e(asset('assetsweb/vendors/isotope/isotope.pkgd.min.js')); ?>"></script>
        <script src="<?php echo e(asset('assetsweb/vendors/slick/slick.min.js')); ?>"></script>
        <script src="<?php echo e(asset('assetsweb/vendors/gsap/gsap.min.js')); ?>"></script>
        <script src="<?php echo e(asset('assetsweb/vendors/gsap/ScrollToPlugin.min.js')); ?>"></script>
        <script src="<?php echo e(asset('assetsweb/vendors/gsap/ScrollTrigger.min.js')); ?>"></script>
        <script src="<?php echo e(asset('assetsweb/vendors/mapbox-gl/mapbox-gl.js')); ?>"></script>
        <script src="<?php echo e(asset('assetsweb/js/theme.min.js')); ?>"></script>
            ...
            <nav class="navbar navbar-expand-xl px-0 py-6 py-xl-12 row align-items-start">
                <div class="col-xl-3 d-flex justify-content-center justify-content-xl-start">
                    <a href="index-2.html" class="navbar-brand py-4 d-lg-inline-block">
                        <img src="assets/images/others/logo.png" height="26" alt="Arif Medico Academy">
                    </a>
                </div>
    ...
    <div id="shoppingCart" data-bs-scroll="false" class="offcanvas offcanvas-end">
        ...
        <div class="offcanvas-footer flex-wrap">
            ...
            <a href="https://templates.g5plus.net/shop/shopping-cart.html" class="btn btn-outline-dark w-100" title="View shopping cart">View shopping cart</a>
        </div>
    </div>
    ...
    <div class="navbar">
        <div id="offCanvasNavBar" class="offcanvas offcanvas-start" style="--bs-offcanvas-width: 310px">
            <div class="offcanvas-header bg-body-tertiary">
                <h3 class="offcanvas-title text-uppercase">Arif Medico Academy</h3>
            ...
            <div class="offcanvas-body pt-0 mb-2">
                <ul class="navbar-nav">
                    <li class="nav-item transition-all-xl-1 py-0 dropdown dropdown-fullwidth">
                        <a class="nav-link d-flex justify-content-between position-relative text-uppercase fw-semibold ls-1 fs-15px dropdown-toggle" href="index.html" data-bs-toggle="dropdown" id="menu-item-home-canvas" aria-haspopup="true" aria-expanded="false">Home</a><div class="dropdown-menu mega-menu start-0 py-6 " aria-labelledby="menu-item-home-canvas" style="width:320px">
                            <div class="megamenu-home container py-8 px-12">
                                <div class="row"><div class="col"><h6 class="fs-18px">Group 1</h6><ul class="list-unstyled"><li>
                                                <a href="home-01.html" class="border-hover text-decoration-none py-3 d-block"><span class="border-hover-target">Home 01</span></a>
                                            </li><li>
                                    ...
                                    </div><div class="col"><h6 class="fs-18px">Group 2</h6><ul class="list-unstyled"><li>
                    ...
                    <li class="nav-item transition-all-xl-1 py-0 dropdown dropdown-fullwidth position-static">
                        <a class="nav-link d-flex justify-content-between position-relative text-uppercase fw-semibold ls-1 fs-15px dropdown-toggle" href="store.html" data-bs-toggle="dropdown" id="menu-item-shop-canvas" aria-haspopup="true" aria-expanded="false">Shop</a><div class="dropdown-menu mega-menu start-0 py-6  w-100" aria-labelledby="menu-item-shop-canvas">
                            <div class="megamenu-shop container-wide py-8 px-12">
                                <div class="row"><div class="col"><h6 class="fs-18px">Shop Pages</h6><ul class="list-unstyled mb-0"><li>
                                    ...
                                    </div><div class="col"><h6 class="fs-18px">Product Pages</h6><ul class="list-unstyled mb-0"><li>
                                    ...
                                    </div><div class="col"><h6 class="fs-18px">Product Types</h6><ul class="list-unstyled mb-0"><li>
                                    ...
                                    <div class="col"><h6 class="fs-18px">Other Pages</h6><ul class="list-unstyled mb-0"><li>
                                                <a href="shop/shopping-cart.html" class="border-hover text-decoration-none py-3 d-block"><span class="border-hover-target">Shopping Cart</span></a>
                                            </li><li>
                    ...
                    <li class="nav-item transition-all-xl-1 py-0 dropdown">
                        <a class="nav-link d-flex justify-content-between position-relative text-uppercase fw-semibold ls-1 fs-15px dropdown-toggle" href="#" data-bs-toggle="dropdown" id="menu-item-pages-canvas" aria-haspopup="true" aria-expanded="false">Pages</a><ul class="dropdown-menu py-6" aria-labelledby="menu-item-pages-canvas"><li class="dropend" aria-haspopup="true" aria-expanded="false">
                    ...
                    <li class="nav-item transition-all-xl-1 py-0 dropdown dropdown-fullwidth">
                        <a class="nav-link d-flex justify-content-between position-relative text-uppercase fw-semibold ls-1 fs-15px dropdown-toggle" href="#" data-bs-toggle="dropdown" id="menu-item-blocks-canvas" aria-haspopup="true" aria-expanded="false">Blocks</a><div class="dropdown-menu mega-menu start-0 py-6 " aria-labelledby="menu-item-blocks-canvas" style="width:800px">
                            <div class="megamenu-home container py-8 px-12">
                                <div class="row">
                                    <div class="col"><h6 class="fs-18px">Group 1</h6>
                                    ...
                                    <div class="col"><h6 class="fs-18px">Group 2</h6>
                                        <ul class="list-unstyled"><li>
                                    ...
                                    <div class="col"><h6 class="fs-18px">Group 3</h6><ul class="list-unstyled"><li>
                                    ...
                                    <div class="col"><h6 class="fs-18px">Group 4</h6><ul class="list-unstyled"><li>
                    ...
                    <li class="nav-item transition-all-xl-1 py-0 dropdown dropdown-fullwidth">
                        <a class="nav-link d-flex justify-content-between position-relative text-uppercase fw-semibold ls-1 fs-15px dropdown-toggle" href="#" data-bs-toggle="dropdown" id="menu-item-docs-canvas" aria-haspopup="true" aria-expanded="false">Docs</a><div class="dropdown-menu mega-menu start-0 py-6 " aria-labelledby="menu-item-docs-canvas">
                            <div class="menumega-docs px-8" style="min-width: 250px">
                                ...
                                <a href="docs/components/accordion.html" class="d-flex text-decoration-none mb-4 mb-lg-0" title="UI Kit">
                                    <div class="flex-shrink-0 fs-5 lh-1 text-muted pt-2">
                                        <svg class="icon"><use xlink:href="#layer-group"></use></svg>
                                    </div>
                                    <div class="flex-grow-1 ps-6">
                                ...
                                <a href="docs/usage/changelog.html" class="d-flex text-decoration-none mb-4 mb-lg-0" title="Changelog">
                                    <div class="flex-shrink-0 fs-5 lh-1 text-muted pt-2">
                                        <svg class="icon"><use xlink:href="#pen-to-square"></use></svg>
                                    </div>
                                    <div class="flex-grow-1 ps-6">
                                ...
                                <a href="https://sp.g5plus.net/" class="d-flex text-decoration-none mb-4 mb-lg-0" title="Support" target="_blank">
                                    <div class="flex-shrink-0 fs-5 lh-1 text-muted pt-2">
                                        <svg class="icon"><use xlink:href="#headset"></use></svg>
                                    </div>
                                    <div class="flex-grow-1 ps-6">
...
<?php /**PATH E:\xampp\htdocs\pharma\resources\views/layouts/web.blade.php ENDPATH**/ ?>
