...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo e((new \App\Library\Contents)->content()->app_name); ?></title>
        ...
        <link href="<?php echo e(asset("assets/plugins/fancy-file-uploader/fancy_fileupload.css")); ?>" rel="stylesheet" />
        <link href="<?php echo e(asset("assets/plugins/Drag-And-Drop/dist/imageuploadify.min.css")); ?>" rel="stylesheet" />
        ...
        <div class="wrapper">
            ...
            <div class="sidebar-wrapper" data-simplebar="true">
                <div class="sidebar-header">
                    <div class="">
                        <img src="<?php echo e(url((new \App\Library\Contents)->content()->logo)); ?>" class="logo-icon-2" alt="" />
                    </div>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a class="" href="<?php echo e(url('admin/news')); ?>">
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="<?php echo e(url('admin/general')); ?>"><i class="bx bx-right-arrow-alt"></i>General Setting</a>
                            </li>
                            <li>
                                <a href="<?php echo e(url('admin/slider')); ?>"><i class="bx bx-right-arrow-alt"></i>Slider</a>
                            </li>
                            <li>
                                <a href="<?php echo e(url('admin/testimonial')); ?>"><i class="bx bx-right-arrow-alt"></i>Testimonial</a>
                            </li>
                            <li>
                                <a href="<?php echo e(url('admin/laws')); ?>"><i class="bx bx-right-arrow-alt"></i>Laws</a>
                            </li>
                            <li>
                                <a href="<?php echo e(url('admin/query')); ?>"><i class="bx bx-right-arrow-alt"></i>Query Types</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a class="" href="<?php echo e(url('admin/client')); ?>">
                            <div class="parent-icon icon-color-10"><i class="bx bx-body"></i>
                            </div>
                            <div class="menu-title">Clients</div>
                        </a>
                    </li>
                    <li>
                        <a class="" href="<?php echo e(url('admin/consultants')); ?>">
                            <div class="parent-icon icon-color-10"><i class="bx bx-body"></i>
                            </div>
                            <div class="menu-title">Consultants</div>
                        </a>
                    </li>
                    <li>
                        <a class="" href="<?php echo e(url('admin/appointments')); ?>">
                            <div class="parent-icon icon-color-10"><i class="bx bx-notepad"></i>
                            </div>
...
<!--                    <div class="flex-grow-1 search-bar">
            ...
            <!--footer -->
            <div class="footer">
                <p class="mb-0">IoTTech Softwares @2023  | Developed By : <a href="https://iottechsoft.com" target="_blank">Amit Kumar</a>
                </p>
            </div>
            <!-- end footer -->
        </div>
        ...
        <script src="<?php echo e(asset("assets/plugins/fancy-file-uploader/jquery.ui.widget.js")); ?>"></script>
        <script src="<?php echo e(asset("assets/plugins/fancy-file-uploader/jquery.fileupload.js")); ?>"></script>
        <script src="<?php echo e(asset("assets/plugins/fancy-file-uploader/jquery.iframe-transport.js")); ?>"></script>
        <script src="<?php echo e(asset("assets/plugins/fancy-file-uploader/jquery.fancy-fileupload.js")); ?>"></script>
        <script src="<?php echo e(asset("assets/plugins/Drag-And-Drop/dist/imageuploadify.min.js")); ?>"></script>
...
<?php /**PATH /home/yantramonline/public_html/taxinq.com/resources/views/layouts/admin.blade.php ENDPATH**/ ?>
