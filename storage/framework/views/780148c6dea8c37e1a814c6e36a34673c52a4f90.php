            ...
            <div class="col-md-6 col-sm-5 co-xs-12 text-right">
                <div class="bread">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="<?php echo e(url('#')); ?>"><?php echo e($blog->title); ?></a></li>
                    </ol>
                </div>
                <!-- end bread -->
            </div>
            ...
            <div class="col-sm-12 col-xs-12 col-md-8">
                <div class="blog-detial">
                    <div class="blog-image">
                        <img alt="blog-image1" class="img-responsive blog-image1" src="<?php echo e(url($blog->pic)); ?>">
                    </div>
                    <div class="blog-content">
                        ...
                        <ul class="post-meta">
                            <li>By <?php echo e($blog->author); ?></li>
                            <li><?php echo e($blog->catName); ?></li>
                            <li><?php echo e($blog->dates); ?></li>
                        </ul>
                    </div>
                    ...
                    <div class="entry-footer">
                        <div class="post-admin">
                            <i class="icon-profile-male"></i>Posted by<a href="#"><?php echo e($blog->author); ?></a>
                        </div>
                        <div class="tags">
                            <i class="fa fa-tags"></i>
                            <?php $__currentLoopData = $blog->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" value="<?php echo e($blog->id); ?>" name="blog_id" class="form-control" required="true">
                ...
                <div class="side-bar">
                    ...
                    <div class="widget">
                        <div class="latest-news">
                            ...
                            <div class="news-post">
                                <?php $__currentLoopData = $blog1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="post">
                    ...
                    <div class="widget">
                        <div class="category">
                            ...
                            <ul>
                                ...
                                <li><a href="<?php echo e(url('blog-category/'.$val->slug)); ?>"><?php echo e($val->title); ?> </a> <span><?php echo e($val->totalcat); ?></span>
                                </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
                    ...
                    <div class="widget">
                        <div class="widget_tag_cloud">
                            ...
                            <div class="tag_cloud">
                                ...
                                <a href="<?php echo e(url('blog-tag/'.$val->tag)); ?>"><?php echo e($val->tag); ?></a>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yantramonline/public_html/taxinq.com/resources/views/web/blog.blade.php ENDPATH**/ ?>
