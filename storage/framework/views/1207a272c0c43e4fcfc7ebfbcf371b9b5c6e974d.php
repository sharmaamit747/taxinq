    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-sm-7 col-xs-12 text-left">
                <h1>Appointment ID: <span class="text-primary"><?php echo e($res->slug); ?></span></h1>
            </div>
            <div class="col-md-6 col-sm-5 col-xs-12 text-right">
                <div class="bread">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo e(url('client/appointments')); ?>">Appointments</a>
                        </li>
                        <li class="active"><?php echo e($res->slug); ?></li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-lg-12">
                        <div class="row">
                            <div class="col-12 col-lg-4"><h1 class="text-center"><b>Query Type:</b></h1><h4 class="text-center"> <?php echo e($res->qtitle); ?></h4></div>
                            <div class="col-12 col-lg-4"><h1 class="text-center"><b>Law:</b></h1><h4 class="text-center"> <?php echo e($res->ltitle); ?></h4></div>
                            <?php if($res->consultant_id == null): ?>
                            <div class="col-12 col-lg-4"><h1 class="text-center"><b>Consultant:</b></h1><h4 class="text-center"> --Not Allocated--</h4></div>
                            <?php else: ?>
                            <div class="col-12 col-lg-4"><h1 class="text-center"><b>Consultant:</b></h1><h4 class="text-center"> <?php echo e($res->cname); ?></h4></div>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="listing-grid">
                                <div class="row">
                                    <div class="col-md-2 col-sm-2 col-xs-12 hidden-xs">
                                        <?php if($res->extra1 != null && $res->extra1 != ''): ?>
                                            <a href="<?php echo e(url($res->extra1)); ?>" class="btn btn-secondary ms-auto radius-10">
                                                <img src="<?php echo e(url('images/att.png')); ?>"><br/> Download<br/> Attachment
                                            </a>
                                        <?php endif; ?>
                                    </div>
                                    <div class="col-md-7 col-sm-8  col-xs-12">
                                        ...
                                        <p style="color:#000;"><?php echo e($res->message); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row m-0">
                                        ...
                                        <p class="mb-0 ms-sm-3 text-muted col-lg-3  text-right">
                                            <a id="chat-btn" pid="<?php echo e($rid); ?>" data-toggle="modal" data-target="#email-chat" href="#" class="btn btn-primary btn-small navbar-btn compose-mail-btn">
                                                <i class="bx bx-plus me-2"></i> Compose
                                            </a>
                                        </p>
                                        <input type="hidden" id="allote-con" value="<?php echo e($rid); ?>" />
                                    </div>
...
<div class="modal fade" id="email-chat" tabindex="-1" role="dialog" aria-labelledby="email-chat" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <form id="email_chat" enctype="multipart/form-data" class="smooth-submit" method="post" action="<?php echo e(url('admin/email_chat')); ?>">
            <div class="modal-content border-primary">
                ...
                <input id="appointmentId" required="true" type="hidden" value="<?php echo e($rid); ?>" class="form-control" name="appointment_id">
                    ...
                    <div class="email-form row">
                        <div class="mb-3 col-lg-8">
                            ...
                            <select name="email[]" class="chat-select" required="true" data-placeholder="Send To" multiple="multiple">
                                <?php $__currentLoopData = $email; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="mb-3 col-lg-8">
                            ...
                            <input id="extraid" name="extraid" type="hidden" class="form-control" value="<?php echo e(time()); ?>">
...
<?php echo $__env->make('layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\taxinq\resources\views/client/appointment.blade.php ENDPATH**/ ?>
