                    ...
                    <div class="modal-body">
                        <div class="row m-0 p-2">
                            ...
                            <div class="col-lg-4 p-2">
                                ...
                                <input accept="image/*" id="blog_img_input" required="true" name="file" onchange="$('#blog_image').attr('src', window.URL.createObjectURL(this.files[0]))" type="file">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\pharma\resources\views/admin/ebook/create_ebook.blade.php ENDPATH**/ ?>
