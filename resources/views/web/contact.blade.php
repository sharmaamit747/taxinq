    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-8 col-sm-8 col-xs-12">
                ...
                <form id="contactForm" class="smooth-submit" method="post" action="{{ url('contact-submit') }}">
                    <div class="row">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12 contact-detail">
                ...
                <div class="contact-info">
                    ...
                    <div class="social-links-two clearfix">
                        <a class="facebook img-circle" href="{{ (new \App\Library\Contents)->content()->facebook_id }}">
                            <span class="fa fa-facebook-f"></span>
                        </a>
                        <a class="twitter img-circle" href="{{ (new \App\Library\Contents)->content()->twitter_id }}">
                            <span class="fa fa-twitter"></span>
                        </a>
                        <a class="google-plus img-circle" mailto="{{ (new \App\Library\Contents)->content()->email }}">
                            <span class="fa fa-google-plus"></span>
                        </a>
                        <a class="linkedin img-circle" href="#">
                            <span class="fa fa-pinterest-p"></span>
                        </a>
                        <a class="linkedin img-circle" href="{{ (new \App\Library\Contents)->content()->linkedin_id }}">
