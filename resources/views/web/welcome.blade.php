                    ...
                    <div class="headl">
                        ...
                        <div class="news-post">
                            <div class="post">
                                ...
                                <h4><a href="{{ url('news-single/'.$val->slug) }}">{{ $val->title }} </a></h4>
    ...
    <div class="col-lg-6 p-0 five">
        <div id="home" class="full-section parallax-home">
            <div class="slider-caption">
                ...
                <a class="btn btn-transparent" href="{{ url('book-appointment') }}"> Book Appointment </a>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-4 col-md-4 col-xs-12  center-responsive">
                <img src="{{ url('assetsweb/images/gst.png')}}" class="img-responsive" alt="">
                <h4><a href="{{ url('services/gst')}}">GST</a></h4>
            ...
            <div class="col-sm-4 col-md-4 col-xs-12 center-responsive get-arrow">
                <img src="{{ url('assetsweb/images/custom.png')}}" class="img-responsive" alt="">
                <h4><a href="{{ url('services/customs')}}">CUSTOMS</a></h4>
                <p class="text-body">the tax imposed on goods when they are transported across international borders.</p>
            </div>
            <div class="col-sm-4 col-md-4 col-xs-12 center-responsive get-arrow">
                <img src="{{ url('assetsweb/images/income.png')}}" class="img-responsive" alt="">
                <h4><a href="{{ url('services/income-tax')}}">INCOME TAX</a></h4>
            ...
            <div class="col-sm-4 col-md-4 col-xs-12  center-responsive">
                <img src="{{ url('assetsweb/images/corporation.png')}}" class="img-responsive" alt="">
                <h4><a href="{{ url('services/corporation-tax')}}">CORPORATION TAX</a></h4>
            ...
            <div class="col-sm-4 col-md-4 col-xs-12 center-responsive get-arrow">
                <img src="{{ url('assetsweb/images/pf.png')}}" class="img-responsive" alt="">
                <h4><a href="{{ url('services/pf-esi')}}">PF & ESI</a></h4>
            ...
            <div class="col-sm-4 col-md-4 col-xs-12 center-responsive get-arrow">
                <img src="{{ url('assetsweb/images/labour.png')}}" class="img-responsive" alt="">
                <h4><a href="{{ url('services/labor-law')}}">LABOUR LAW</a></h4>
            ...
            <div class="col-lg-3 margin-b30 col-md-6 aos-init" data-aos="fade-right" data-aos-duration="1400">
                <div class="project-item-two">
                    ...
                    <div class="project-content-two">
                        <ul>
                            <li><a href="{{ $val->facebook }}" class="facebook img-circle"><span class="fa fa-facebook-f"></span></a></li>
                            <li><a href="{{ $val->twitter }}" class="twitter img-circle"><span class="fa fa-twitter"></span></a></li>
                            <li><a href="{{ $val->linkedin }}" class="linkedin img-circle"><span class="fa fa-linkedin"></span></a></li>
                            <li><a href="{{ $val->instagram }}" class="linkedin img-circle"><span class="fa fa-linkedin"></span></a></li>
                        </ul>
                    </div>
                    <div class="team-pera text-center margin-t">
                        <h1 class="font-lora font-24 lineh-24 color-29 weight-600 margin-b12"><a href="{{ url('consultant/'.$val->slug) }}" class="color-29">{{ $val->name }}</a></h1>
                        <p class="font-16 lineh-16 weight-500 color-30 font-ks">{{ $val->title }}</p>
                    </div>
                </div>
            </div>
            @endforeach
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="blog-grid">
                    <div class="blog-image">
                        <img alt="blog-image1" class="img-responsive" src="{{ url($val->pic) }}">
                    </div>
                    ...
                    <div class="blog-footer">
                        <ul class="like-comment">
                            ...
                            <li>
                                <a href="#"><i class="icon-chat"></i>{{ $val->count }}</a>
                            </li>
                        </ul>
                    ...
                    <div class="item">
                        ...
                        <div class="client-info-wrap clearfix">
                            <div class="client-img">
                                <img class="img-circle" src="{{ url($val->pic) }}" alt="" />
                            </div>
            ...
            <div class="client-block item">
                <div class="client-item client-item-style-2">
                    <a title="Client Logo" href="#">
                        <img alt="Clients Logo" src="{{ url($val->pic) }}">
                    </a>
                </div>
            </div>
            @endforeach
