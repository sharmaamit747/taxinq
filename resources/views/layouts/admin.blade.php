...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ (new \App\Library\Contents)->content()->app_name }}</title>
        ...
        <div class="wrapper">
            ...
            <div class="sidebar-wrapper" data-simplebar="true">
                <div class="sidebar-header">
                    <div class="">
                        <img src="{{ url((new \App\Library\Contents)->content()->logo)}}" class="logo-icon-2" alt="" />
                    </div>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="{{ url('admin/blog') }}"><i class="bx bx-right-arrow-alt"></i>Blogs</a>
                            </li>
                            <li>
                                <a href="{{ url('admin/blog-categories') }}"><i class="bx bx-right-arrow-alt"></i>Categories</a>
                            </li>
                            <li>
                                <a href="{{ url('admin/blog-tags') }}"><i class="bx bx-right-arrow-alt"></i>Tags</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="{{ url('admin/general') }}"><i class="bx bx-right-arrow-alt"></i>General Setting</a>
                            </li>
                            <li>
                                <a href="{{ url('admin/slider') }}"><i class="bx bx-right-arrow-alt"></i>Slider</a>
                            </li>
                            <li>
                                <a href="{{ url('admin/testimonial') }}"><i class="bx bx-right-arrow-alt"></i>Testimonial</a>
                            </li>
                            <li>
                                <a href="{{ url('admin/laws') }}"><i class="bx bx-right-arrow-alt"></i>Laws</a>
                            </li>
                            <li>
                                <a href="{{ url('admin/query') }}"><i class="bx bx-right-arrow-alt"></i>Query Types</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a class="" href="{{ url('admin/client') }}">
                    ...
                    <li>
                        <a class="" href="{{ url('admin/consultants') }}">
                            <div class="parent-icon icon-color-10"><i class="bx bx-body"></i>
                            </div>
                    ...
                    <li>
                        <a class="" href="{{ url('admin/appointments') }}">
                            ...
                            <li class="nav-item dropdown dropdown-user-profile">
                                <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;" data-bs-toggle="dropdown">
                                    <div class="d-flex user-box align-items-center">
                                        ...
                                        <img src="{{ url('assets/images/avatars/avatar-1.png') }}" class="user-img" alt="user avatar">
                                    </div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end">	
