...
<!--                            <div class="col-lg-6 p-2">
                    ...
                    <div class="modal-footer col-lg-12">
                        <button  class="btn btn-danger float-right" data-dismiss="modal">{{ __('messages.Cancel') }}</button>
                        <button  class="btn btn-primary float-right">{{ __('messages.Create') }}</button>
                    </div>
                </div>
            </form>
        </div>
...
<!--                            <div class="col-lg-6 p-2">
                    ...
                    <div class="modal-footer col-lg-12">
                        <button  class="btn btn-danger float-right" data-dismiss="modal">{{ __('messages.Cancel') }}</button>
                        <button  class="btn btn-primary float-right">{{ __('messages.Update') }}</button>
                    </div>
                </div>
            </form>
        </div>
