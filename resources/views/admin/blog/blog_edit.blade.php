...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <form id="edit_blogss" class="smooth-submit" method="post" action="{{ url('admin/edit_blogss') }}">
            <div class="form-body">
                    ...
                    <div class="row m-0 p-2">
                        <div class="col-lg-4 p-2">
                            <div class="form-group">
                                ...
                                <select required="true" class="form-control" name="bcategory">
                                    ...
                                    @foreach($cat as $val)
                                    <option value="{{ $val->id }}" @if($res->category_id == $val->id) selected @endif>{{ $val->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-4 p-2">
                            <div class="form-group">
                                ...
                                <input required="true" type="text" class="form-control" value="{{ $res->title}}" id="" name="btitle">
                            </div>
                        </div>
                        <div class="col-lg-4 p-2">
                            <div class="form-group">
                        ...
                        <div class="col-lg-12 p-2">
                            <div class="form-group">
                                ...
                                <select name="tags[]" class="form-select" id="multiple-tag2-field" data-placeholder="Choose anything" multiple>
                                    @foreach($tag as $val)
                                    <option @if(in_array($val->tag, explode(',',$res->tag_id))) selected @endif>{{ $val->tag }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
